...
| -- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| #5 | feature/1-project-foundation | "Correct Tech Stack initialization. Everything lgtm."                                                                                                                                                |
...
| -- | ----- | ---------- | ------------------ |
| #2 | feat: setup project foundation (Issue #1) | "Initial Stack correct lgtm." | Approved and merged |
| #3 | feat: implement API health check (issue #2) | "Health Check API test works." / "Health test UI lgtm." | Approved and merged |
| #4 | feat: create and seed IT request categories (issue #3) | "Database Table Schema Correct. Prisma model match to table Schema. Seeding with ORM works." | Approved and merged |
| #5 | feat: display IT request category list (issue #4) | "category GET API via Prisma ORM works. API Return JSON correct format. React can display API response. Vitest test and Super test OK." | Approved and merged |
