...
| #25 | #17 E2E tests         | Under review — no reviewer comments yet. Author logged a manual-test fix in-thread: E2E-04 initially captured the stale My Tickets screen for create-ticket because the screenshot ran before the SPA route rendered; now waits for URL + Category field (commits d4a6ffe, 074c641). | Open |
