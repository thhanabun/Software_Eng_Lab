...
describe("absent staff/admin routes stay silent (AUTHZ-02/03/04, AUTHZ-08)", () => {
  it("requester probing notes/admin/staff paths gets safe 404s with no content", async () => {
